    ...
    public partial class initial3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, @"1) Visit the Space Needle 
                 2) Ride the Duck 
                 3) Tour Pike Place Market 
                ", 1 },
                    { 9, 5, 0, @"1) Test 1 activity 
                2) Test 2 acivity.
                3) Test 3 activity.
                 ", 0 },
                    { 8, 2, 0, @"1) Take a tour of Seattle underground with Bill Speidel's Underground Tour. 
                2) Get some drinks at some great bars on Capitol Hill.
                3) Get a bite to eat with a great view at the Six Seven Restaurant.
                 ", 0 },
                    { 7, 2, 1, @"1) Visit the Buffalo Museum of Science.
                ...
                ", 1 },
                    { 6, 2, 0, @"1) Fly high indoors at IFly. An exiciting indoors skydiving center located only mintues outside of Seattle 
